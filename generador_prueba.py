...
def main():
    ...
    try:
        ...
        instance_objeto_detallepago = clases.DetallePagoInput()
        ...
        vector_sucursal = [instance_objeto_sucursal.getSucursal(),  
                          ...
                          instance_objeto_sucursal.calcular_total_comision(), "Iva sin calcular"]
        ...
        vector_pagos = [instance_objeto_pagos.getCodRegistro(), instance_objeto_pagos.getCaja(), instance_objeto_pagos.getCajero(), instance_objeto_pagos.getLote(),  
                        instance_objeto_pagos.calcular_cant_registros(), instance_objeto_pagos.calcular_importe_determinado_y_pagado(),
                        instance_objeto_pagos.calcular_importe_determinado_y_pagado(),
                        instance_objeto_pagos.calcular_total_comision(), "Iva sin calcular"]
        
        vector_detalle_pago = [instance_objeto_detallepago.getNroBoleta(), instance_objeto_detallepago.getFechaPago(),
