class DetallePagoBPC():
    def __init__(self, codbarra1, codbarra2):
    ...
    def calcular_imp_determinado_pagado(self, tipopago): #para pagospresenciales
    ...
    def calcular_imp_recaudado_depositado_adepostar(self, tipopago):
