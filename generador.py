...
from lectura_archivo_config import leer_ini_bancos, leer_ini_comisiones, leer_ini_tags

def generar_xml(origen_ok, banco_ok, fecha_rendicion_ok, vector_boletas_ok, vector_importes_ok, vector_fechapagos_ok, vector_cantcuotas_ok, vector_cuotaactual_ok):
    
    vec_claves, vec_comisiones = leer_ini_comisiones(banco_ok)
    nro_bancos, nombres_bancos = leer_ini_bancos()
    tag_general, tag_sucursal, tag_pagos, tag_dp = leer_ini_tags(origen_ok, banco_ok)
